$(document).ready(function(){
  ...
  let trContent = {
    ...
    projectsZeroPara: "nomat günlük işlerinizde size yardım eden yararlı bir robot olması amaçlanmaktadır. Akıllı, küçük ve hızlıdır. Açık-kod kaynağına sahip, nazikçe modifiye edilmiş standart elektronik devrelerden meydana gelmektedir. 3D yazıcı ile üretilebilir mekanik parçalara sahiptir. <br><br><b>2021 Agustos itibariyle geliştirilmeye devam edilmektedir.</b>",
    projectsOnePara: "Göcheni IoT ve Robotik bilim alanlarına amade, minimalist bir platformdur. <br><br><b>2021 Ağustos ayı itibariyle geliştirilmeye devam edilmektedir.</b>",
    teamHeader: "Takım",
    ...
    ftContactPara: "Danışma, geri bildirim ve tavsiyeleriniz için <a class=\"text-success\" href=\"mailto:emrullahjack@gmail.com\">emrullahjack@gmail.com</a> adresine mail atmaktan çekinmeyin. <br>KoyuLab Takımı tarafından 💚 ile geliştirildi (Ağustos 2021'de güncellendi)",
  ...
  let enContent = {
    ...
    projectsZeroPara: "nomat is aimed to be a utility robot that helps you accomplish your daily tasks. It is smart, small and swift. It has open-source software, gently modified off-the-shelf electronics, and 3D printable mechanical parts. <br><br><b>Currently in development as of August 2021.</b>",
    projectsOnePara: "Göcheni is a minimalist platform for IoT and Robotics purposes. <br><br><b>Currently in development as of August 2021.</b>",
    teamHeader: "Team",
    ...
    ftContactPara: "For all inquiries, recommendations, feedback or anything else, email to <a class=\"text-success\" href=\"mailto:emrullahjack@gmail.com\">emrullahjack@gmail.com</a><br>Designed by KoyuLab team with 💚 (updated on August 2021)",
