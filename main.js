$(document).ready(function(){
  ...
  let trContent = {
    ...
    projectsOnePara: "<a href=\"https://koyubulut.tr/\" target=\"_blank\" class=\"text-success\">KoyuBulut</a> Nesnelerin interneti ve robotik bilim alanlarına yönelik minimalist bir platformdur. Nesnelerin interneti projelerinizi sağladığı ücretsiz MQTT sunucusuna bağlayabilir ve projelerinize interneti olan her yerden erişebilirsiniz. Aynı zamanda nesnelerin interneti tabanlı hizmet alım/satımı yapabilirsiniz (geliştirilmektedir).<br><br><b>2025 Aralık ayı itibariyle geliştirilmeye devam edilmektedir.</b>",
    teamHeader: "Takım",
    teaMemBriefArr: ["Kurucu ve geliştirici<br><a class=\"text-success\" href=\"https://bionluk.com/emrullahoztosun\" target=\"_blank\">Freelancer @ Bionluk</a></span>", "Uzaktan denetçi", "Bilgisayarlı görüntüleme geliştiricisi", "Çevirmen (Türkçe / Ingilizce)", "Elektrik/Elektronik Mühendisi"],
    ftContactPara: "Danışma, destek verme, geri bildirim ve iletişim için <a class=\"text-success\" href=\"https://sosyal.teknofest.app/@emrullah_oztosun\">Emrullah\'ın NSosyal hesabına</a> DM atabilirsiniz. <br>KoyuLab Takımı tarafından 💚 ile geliştirildi (Kasım 2025'de güncellendi)",
  ...
  let enContent = {
    ...
    aboutUsPara: "KoyuLab started as an idea in 2018 by Emrullah Öztosun. This lab's main goals are to simplify IoT and Robotics fields, encourage people with less skills and knowledge to build things of their own and connect them to the internet, and make further research in physical computing for knowing Allah better. <br><br>To pursue these goals, we have been working relentlessly for the past 7 years. We made significant progress to achieve our goals with our projects and we dream making more!",
    projectsHeader: "Projects",
    projectsZeroPara: "nomat is a general purpose unmanned land vehicle (ULV). It is smart, small and swift. It has an elaborately designed and rigorously implemented software, gently modified off-the-shelf electronics, and 3D printable mechanical parts. <b>Currently in development as of October 2024.</b>", // <br><a class=\"text-success\" href=\"./nomat-pt3.html\">nomat pt-3 geliştirme girdileri</a>
    projectsOnePara: "<a href=\"https://koyubulut.tr/\" target=\"_blank\" class=\"text-success\">KoyuBulut</a> is a minimalist platform for IoT and Robotics purposes. It serves as an MQTT broker and also provides an interface full of various widgets for use by IoT makers. It also enables buying and selling IoT based services.<br><br><b>Currently in development as of December 2025.</b>",
    teamHeader: "Team",
    teaMemBriefArr: ["Founder &amp; Developer<br><a class=\"text-success\" href=\"https://bionluk.com/emrullahoztosun\" target=\"_blank\">Freelancer @ Bionluk</a></span>", "Remote Tester", "Computer Vision Developer", "Translator (Turkish/English)", "Electrical/Electronics Engineer"],
    ftContactPara: "For all inquiries, recommendations, feedback, etc. contact <a class=\"text-success\" href=\"https://sosyal.teknofest.app/@emrullah_oztosun\">Emrullah\'s NSosyal Account</a><br>Designed by KoyuLab team with 💚 (updated on November 2025)",
